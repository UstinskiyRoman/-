...
type
  ...
  public
    ...
    function GetAnswerImage (ImageName: String): String;
  end;
...
function TDataModuleBase.GetAnswerImage(ImageName:String): String;
begin
 with ADOQueryBase do
     begin
     Close;
      SQL.Clear;
      SQL.Text:='SELECT RisPrav FROM Otveti WHERE RisBig=' + ImageName + ' ';
      Open;
      Result:= ADOQueryBase.Fields[0].AsString;
     end;
end;
