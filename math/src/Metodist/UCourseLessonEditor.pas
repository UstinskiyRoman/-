...
type
  TFCourseLessonEditor = class(TFormBase)
    ...
    Label6: TLabel;
    Label7: TLabel;
    memoTheoryLesson: TMemo;
    Label8: TLabel;
    memoTheoryUpdatingLessons: TMemo;
    Label9: TLabel;
...
begin
  ...
  begin
    ...
    memoTheoryUpdatingLessons.Clear;
...
begin
  ...
  memoTheoryUpdatingLessons.Text := lessons[cmbLessonsForUpdate.ItemIndex].theory;
...
begin
  ...
  DataModuleEditor.CreateLesson(editLessonName.Text, memoDescriptionLesson.Text, memoTheoryLesson.Text, courses[cmboxCoursesForNewLessons.ItemIndex].ID, StrToInt(lbleditOrderLesson.Text),StrToInt(cmbClass.Text));
...
begin
  ...
  DataModuleEditor.UpdateLessons(lessons[cmbLessonsForUpdate.ItemIndex].ID, lblEditUpdLesson.Text, memoDescriptionUpdatingLessons.Text, memoTheoryUpdatingLessons.Text, courses[cmbCourses.ItemIndex].ID, StrToInt(lbleditOrderLesson2.Text),StrToInt(cmbUpdCl.Text));
